...
import SubtitleManager, { SubtitleBlock } from "@/components/subtitles/SubtitleManager";
...
export default function EditorPage() {
  const [subtitles, setSubtitles] = React.useState<SubtitleBlock[]>([]);
  return (
            ...
            <Tabs defaultValue="timeline" className="w-full">
              ...
              <TabsContent value="subtitles">
                <div className="bg-white dark:bg-gray-900 rounded-lg shadow p-4 mb-4">
                  ...
                  <SubtitleManager onChange={setSubtitles} />
                </div>
              </TabsContent>
